...
# Drone Relay Docker destructive test installer for linuxbox2.
#
# Normal deploy:
#   curl -fsSL https://raw.githubusercontent.com/jamesking210/drone-relay-docker/main/install.sh | bash
#
# This installer intentionally replaces /opt/drone-relay and copies .env.example to .env.
